...
extension AppDelegate {
    func setupJpush(launchOptions: [UIApplicationLaunchOptionsKey: Any]?)   {
        //44623a31b45b2a4ed6d47615
//        JPUSHService.setup(withOption: launchOptions, appKey: "d412b5e65ca36c3d88f74b4b", channel: "WYAppStore", apsForProduction: true, advertisingIdentifier: nil)
...
//        mylog(userinfo)
//        if let actionkey = userinfo["type"] {
//
//            if let actionkeyStr = actionkey as? String {
//
//                if  actionkeyStr == "1" {//收到约定消息 (刷新首页,收款人订单列表)
//
//                    DDNotification.postReloadMessageList()
//                    if let value = userinfo["data"] {
//                        mylog("good成功\(value)")
//                    }else{mylog("\(actionkeyStr)对应的value为空")}
//
//                }else if (actionkeyStr == "2"){//收到好友消息(刷新首页与聊天框,好友列表)
//
//                    DDNotification.postReloadMessageList()
//                    if let value = userinfo["data"] {
//                        mylog("good成功\(value)")
//                    }else{mylog("\(actionkeyStr)对应的value为空")}
//
//                }else if (actionkeyStr == "3"){//有新的公开约定(刷新公开约定列表)
//
//                    if let value = userinfo["data"] {
//                        mylog("good成功\(value)")
//                    }else{mylog("\(actionkeyStr)对应的value为空")}
//
//                } else if (actionkeyStr == "4"){//有新的资金信息(刷新我的页面)
//                    DDNotification.postReloadMessageList()
//                    DDNotification.postReloadMeItem()
//                    if let value = userinfo["data"] {
//                        mylog("good成功\(value)")
//                    }else{mylog("\(actionkeyStr)对应的value为空")}
//                }
